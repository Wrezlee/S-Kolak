...
class DashboardPublikController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Data publik langsung dimuat meskipun belum ada filter yang diterapkan —
        // tanpa filter, semua data valid ditampilkan. $hasFilter tetap dihitung
        // untuk kebutuhan lain (mis. menandai filter mana yang sedang aktif di UI).
    ...
    /**
     * Query dasar data publik (hanya status valid) dengan filter periode & komoditas
     * yang sama diterapkan, dipakai baik untuk hitung ringkasan/tren (seluruh data)
     * maupun untuk tabel yang dipaginasi.
     */
    ...
    /**
     * Cek apakah pengguna sudah menerapkan minimal satu filter (rentang periode
     * awal, rentang periode akhir, atau komoditas). Dipakai untuk menahan data
     * publik supaya tidak langsung tampil semua sebelum difilter.
     */
