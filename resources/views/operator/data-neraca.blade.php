        ...
        <main id="pageContent" class="flex-1 overflow-y-auto p-4 sm:p-6 space-y-5">
            ...
            <div class="bg-white rounded-xl border border-blue-100 shadow-sm overflow-hidden">
                ...
                <form method="GET" class="p-4 border-b border-blue-50 flex items-center gap-3 flex-wrap">
                    ...
                    @if (request('search'))
                        <a href="{{ route('operator.data') }}" class="text-xs text-slate-400 hover:text-slate-600">Reset</a>
                    @endif
                </form>
                                    ...
                                    <td class="px-4 py-3">
                                        ...
                                        @else
                                            <button type="button" onclick='openDetail({!! $payload !!})'
                                                    class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-blue-200 text-blue-600 text-xs font-medium hover:bg-blue-100 transition-colors">
