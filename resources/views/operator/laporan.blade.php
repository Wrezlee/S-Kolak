...
@php
    ...
    $totalEntriSaya = $totalEntriSaya ?? 0;
        ...
        <nav class="flex-1 p-3 space-y-0.5 overflow-y-auto mt-2">
            @php
                $menuItems = [
                    ...
                    ['key' => 'data',       'label' => 'Data Neraca',         'route' => 'operator.data',       'badge' => $totalEntriSaya],
        ...
        <main id="pageContent" class="flex-1 overflow-y-auto p-4 sm:p-6 space-y-5">
            ...
            <div class="flex items-center justify-between flex-wrap gap-3">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('operator.laporan.cetak', request()->query()) }}" class="flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold text-white shadow-sm" style="background-color:#2563EB;" target="_blank" rel="noopener">
            ...
            {{-- Filter --}}
            <form id="filterForm" method="GET" action="{{ route('operator.laporan') }}" class="bg-white rounded-xl border border-blue-100 shadow-sm p-4">
                ...
                <div class="flex flex-wrap gap-3 items-end">
                    ...
                    <a href="{{ route('operator.laporan') }}" class="px-3 py-2 rounded-lg border border-slate-200 text-xs text-slate-500 hover:bg-slate-50 flex items-center gap-1">
            ...
            <div id="tab-ringkasan" class="tab-panel space-y-4">
                ...
                <div class="bg-white rounded-xl border border-blue-100 shadow-sm p-5">
                    <h3 class="text-sm font-bold mb-4" style="color:#1E3A5F;">Rekap per Komoditas – Data Saya</h3>
                ...
                {{-- Nilai neraca valid --}}
                <div class="bg-white rounded-xl border border-blue-100 shadow-sm p-5">
                    <h3 class="text-sm font-bold mb-4" style="color:#1E3A5F;">Nilai Neraca Komoditas Valid – Data Saya</h3>
            ...
            <div id="tab-grafik" class="tab-panel space-y-5 hidden">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    <div class="bg-white rounded-xl border border-blue-100 shadow-sm p-5">
                        <h3 class="text-sm font-bold mb-4" style="color:#1E3A5F;">Entri per Komoditas – Data Saya</h3>
                ...
                (function () {
                    ...
                    function renderCharts() {
                        if (typeof Chart === 'undefined') {
                            // Chart.js dimuat lewat <script src> di <head> halaman ini.
                            // Kalau halaman ini dibuka lewat SPA nav dari halaman lain
                            // yang <head>-nya tidak memuat Chart.js, library-nya belum
                            // ada -> muat dulu di sini sebelum menggambar grafik.
