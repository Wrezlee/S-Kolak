...
<div class="flex h-screen overflow-hidden">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="h-14 border-b border-blue-100 bg-white flex items-center px-4 gap-3 flex-shrink-0 shadow-sm">
            <div class="flex-1">
                <h2 id="pageHeaderTitle" class="text-sm font-bold" style="color:#1E3A5F;">Manajemen Pengguna</h2>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex gap-1.5">
                                            <button type="button"
                                                    ...
                                                    class="p-1.5 rounded-lg border border-blue-200 text-blue-500 hover:bg-blue-100 transition-colors" title="Edit">
                                            ...
                                            <button type="button"
                                                    ...
                                                    class="p-1.5 rounded-lg border border-red-100 text-red-400 hover:bg-red-100 transition-colors" title="Hapus">
