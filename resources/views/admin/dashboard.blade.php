    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6">
            ...
            <div class="grid grid-cols-2 xl:grid-cols-4 gap-4">
                @php
                    $statCards = [
                        ['label' => 'Total Entri Neraca',  'value' => $summary['total'],    'color' => 'blue',   'icon' => 'database'],
                        ['label' => 'Data Valid',           'value' => $summary['valid'],    'color' => 'green',  'icon' => 'check'],
                        ['label' => 'Menunggu Verifikasi',  'value' => $summary['menunggu'], 'color' => 'orange', 'icon' => 'clock'],
                        ['label' => 'Perlu Revisi',         'value' => $summary['revisi'],   'color' => 'red',    'icon' => 'warning'],
                    ];
                    $statColorMap = [
                        ...
                        'orange' => ['card' => 'bg-yellow-50 border-yellow-200', 'icon' => 'bg-yellow-100 text-yellow-600'],
                        'red'    => ['card' => 'bg-red-50 border-red-200',       'icon' => 'bg-red-100 text-red-600'],
                    ];
                    $statIcons = [
                ...
                @foreach ($statCards as $card)
                    ...
                    <div class="{{ $sc['card'] }} rounded-xl border shadow-sm p-5 flex items-start gap-4">
