...
<div class="flex h-screen overflow-hidden">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="h-14 border-b border-blue-100 bg-white flex items-center px-4 gap-3 flex-shrink-0 shadow-sm">
            <div class="flex-1">
                <h2 id="pageHeaderTitle" class="text-sm font-bold" style="color:#1E3A5F;">Data Neraca Pangan</h2>
                ...
                <form method="GET" class="p-4 border-b border-blue-50 flex items-center gap-3 flex-wrap">
                    <div class="flex items-center gap-2 flex-1 min-w-[220px] px-3 py-2 rounded-lg border border-blue-100 bg-blue-50/30">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                               placeholder="Cari komoditas, operator, atau verifikator..."
                    ...
                    @if (request('search'))
                        <a href="{{ route('admin.data') }}" class="text-xs text-slate-400 hover:text-slate-600">Reset</a>
                    @endif
                </form>
