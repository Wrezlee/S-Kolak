        ...
        <main class="flex-1 overflow-y-auto p-4 sm:p-6 space-y-5">
            ...
            <div class="flex items-center justify-between flex-wrap gap-3">
                ...
                <div class="flex gap-2">
                    <a href="{{ Route::has('admin.data.export.excel') ? route('admin.data.export.excel', request()->query()) : '#' }}" class="flex items-center gap-1.5 px-3 py-2 rounded-lg border border-blue-200 text-blue-600 text-sm hover:bg-blue-50 transition-colors">
                                    ...
                                    <td class="px-3 py-3">
                                        <div class="flex gap-1.5">
                                            <button type="button" onclick='openDetail({!! $detailPayload !!})'
                                                    class="px-2 py-1 rounded-lg border border-blue-200 text-blue-600 text-xs hover:bg-blue-50 transition-colors">
                                            ...
                                            <button type="button" onclick='openDelete({!! $deletePayload !!})'
                                                    class="px-2 py-1 rounded-lg border border-red-100 text-red-500 text-xs hover:bg-red-50 transition-colors">
